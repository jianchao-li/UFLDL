...
data_train = loadMNISTImages('../common/common/train-images-idx3-ubyte');
labels_train = loadMNISTLabels('../common/common/train-labels-idx1-ubyte');
labels_train  = labels_train + 1;

data_test = loadMNISTImages('../common/common/t10k-images-idx3-ubyte');
labels_test = loadMNISTLabels('../common/common/t10k-labels-idx1-ubyte');
